# -*- coding: utf-8 -*-
"""
Created on Fri Apr 10 10:15:40 2020
...
if __name__=="__main__":
    ...
    for i in range(len(label)):
        if label[i]==0 or label[i]==1 or label[i]==7:
            label[i]=1
        elif label[i]==2 or label[i]==4 or label[i]==8:
            label[i]=2
        elif label[i]==3 or label[i]== 5 or label[i]==6:
            label[i]=3
    for i in range(len(label)):
        if label[i]==1 :
            label[i]=1
